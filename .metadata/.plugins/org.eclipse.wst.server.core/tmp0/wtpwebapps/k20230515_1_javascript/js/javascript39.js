...
//	createTextNode(): 태그 내부에 들어갈 문자열을 만든다. => 태그는 적용되지 않는다.
...
//	p.appendChild(txt);
//	textContent: createTextNode() 함수로 문자열을 만들고 appendChild() 함수를 실행한 것처럼 태그 내부에
//	문자열을 넣어준다.
...
function moveElement() {
	let fieldset = document.getElementById('addEle');
//	console.log(fieldset.children); // legend, div
