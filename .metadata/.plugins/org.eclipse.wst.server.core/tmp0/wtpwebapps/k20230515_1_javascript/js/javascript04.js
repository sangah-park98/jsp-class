...
//	디폴트 인수 => ES6 추가
//	디폴트 인수를 사용하지 않으면 인수가 넘어온 값으로 함수를 실행하지만 인수가 넘어오지 
//	않으면 undefined로 처리된다.
...
function quiz(answer, yes, no){ // yes, no는 함수가 할당된 변수
	if(answer == '사랑해') {
		yes();
	} else {
		no();
...
quiz('미워해', () => console.log('Yes!'), () => console.log('No!'));
//	화살표(arrow) 함수
//	일반 익명 함수
...
const simplePrint3 = () => console.log('화살표 함수 simplePrint3() 실행');
simplePrint3();
console.log('-----------------------');
