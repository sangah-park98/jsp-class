...
//	img 태그를 만들고 src 속성값을 radioValue에 저장된 값으로 저장하면 된다.
	let img = document.createElement('img'); // <img>
	img.setAttribute('src', radioValue); // <img src="./images/img02.jpg">

//	img 태그를 넣어줄 div 태그를 얻어온다.	
	let div = document.getElementById('imgView');
	
//	라디오 버튼을 선택하고 이미지 생성 버튼을 클릭할 때마다 이미지가 변경되게 하려면 기존에 있던 
